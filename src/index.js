    ...
    return (
      <div className="entry">
        <fieldset>
          <legend>記帳</legend>
          <div>
            <input type="radio" value="on" checked={this.state.payingIn} onChange={(e => this.onChanePayingIn(e))} /> 入金
          </div>
          <div>
            <input type="radio" value="off" checked={!this.state.payingIn} onChange={(e) => this.onChanePayingIn(e)} /> 出金
          </div>
          <div>
